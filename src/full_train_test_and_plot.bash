...
MPIIGAZE_FILE="../preprocess/outputs_faze/MPIIGaze.h5
GAZECAPTURE_FILE="../preprocess/outputs_faze/GazeCapture.h5
...
then
	...
	TRAIN_CMD="1_train_dt_ed.py \
        ...
        "
#    eval "python3 -m torch.distributed.launch --nproc_per_node=4 $TRAIN_CMD --distributed --use-apex \ --skip-training \; "
...
ML_COMMON=" --disable-tqdm --output-dir ./ --meta-learner Meta-SGD"
